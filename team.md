...
### Варіанти <DyvoBadge color="warning">оновлено</DyvoBadge>

<style>
.team-badge-matrix tr:nth-child(2n) {
...
<span style="vertical-align: middle;"> DyvoBadge можна використовувати з зображенням.</span>
